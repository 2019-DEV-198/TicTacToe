...
class UIViewTests: XCTestCase {
    ...
    func testTapTranslatesToPosition() {
        ...
        let position2 = view.gamePosition(for: CGPoint(x: 300, y: 99), sizeX: Game.width, sizeY: Game.height)
        ...
        let position5 = view.gamePosition(for: CGPoint(x: 300, y: 150), sizeX: Game.width, sizeY: Game.height)
        ...
        let position8 = view.gamePosition(for: CGPoint(x: 300, y: 300), sizeX: Game.width, sizeY: Game.height)
